...
function StatCard({ title, value, change, icon: Icon, trend, colorClass }: StatCardProps) {
  return (
    <div className="group relative overflow-hidden rounded-[2rem] border border-slate-200 bg-white p-7 shadow-xl shadow-slate-200/30 transition-all hover:shadow-2xl hover:-translate-y-1">
      {/* Decorative background glow */}
      <div className={cn("absolute -right-4 -top-4 h-24 w-24 rounded-full opacity-[0.03] transition-transform group-hover:scale-150", colorClass)} />
      
      <div className="flex items-start justify-between">
        <div className="space-y-3">
          <div className="flex h-12 w-12 items-center justify-center rounded-2xl bg-slate-50 border border-slate-100 shadow-sm transition-colors group-hover:bg-white">
        ...
        <div className={cn(
          ...
          trend === "up" ? "bg-emerald-50 text-emerald-600 border-emerald-100" : "bg-slate-50 text-slate-500 border-slate-100"
        )}>
  ...
  return (
    <div className="space-y-10">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        {/* Fulfillment Progress Card (Dark Mode) */}
        <div className="lg:col-span-2 rounded-[2.5rem] bg-slate-900 p-10 text-white shadow-2xl relative overflow-hidden group border border-slate-800">
          <div className="relative z-10 flex flex-col justify-between h-full">
            <div className="space-y-2">
              ...
              <h2 className="text-3xl font-black tracking-tight">Daily Fulfillment Goal</h2>
            ...
            <div className="mt-12 space-y-5">
              ...
              <div className="h-4 w-full bg-slate-800 rounded-full overflow-hidden p-1 border border-slate-700">
                <div 
        ...
        {/* Quick Insights Card */}
        <div className="rounded-[2.5rem] border-2 border-slate-100 bg-white p-10 flex flex-col justify-between shadow-sm">
          <div className="space-y-8">
            ...
            <div className="space-y-6">
              <div className="flex gap-5">
                <div className="h-12 w-12 shrink-0 rounded-2xl bg-amber-50 flex items-center justify-center text-amber-600 font-black text-lg shadow-sm border border-amber-100">
                  !
                </div>
                <div>
                  <p className="text-sm font-black text-slate-900">Inventory Alert</p>
              ...
              <div className="flex gap-5">
                <div className="h-12 w-12 shrink-0 rounded-2xl bg-emerald-50 flex items-center justify-center text-emerald-600 shadow-sm border border-emerald-100">
          ...
          <button className="mt-8 w-full py-4 rounded-2xl bg-slate-900 text-[11px] font-black uppercase tracking-[0.2em] text-white hover:bg-primary transition-all active:scale-95 shadow-lg shadow-slate-200">
            View Full Report
          </button>
        </div>
