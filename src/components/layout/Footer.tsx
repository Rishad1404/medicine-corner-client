...
export default function Footer() {
    return (
        <footer className="">
            <div className="mx-auto max-w-full px-6 py-10 bg-background">
                <Link
                    href="/"
                    aria-label="go home"
                ...
                <span className="text-muted-foreground block text-center text-sm"> © {new Date().getFullYear()} Medicine Corner, All rights reserved</span>
            </div>
        </footer>
    )
}
