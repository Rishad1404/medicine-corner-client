...
import { AlignStartVertical, BarChart3, CircleUserRound, ClipboardList, Languages, LucideIcon, Notebook, NotepadText, Table, Ticket, } from "lucide-react";
...
export const navData: NavItem[] = [
    ...
    { title: "Analytics", icon: BarChart3, href: "/block/dashboard-shell-01/preview" },
